          ...
          <div className="relative rounded-3xl overflow-hidden glass p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="lg:max-w-xl relative z-10">
              <span className="text-[10px] uppercase font-bold tracking-widest text-brand-purple bg-brand-purple/10 px-3 py-1 rounded-full border border-brand-purple/15 inline-flex items-center gap-1.5 mb-6">
                ...
                Logistic Automation Case Study
              </span>

              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 leading-snug">
                Slashed lead response time by 85% for Sharma Logistics & Distribution
              </h3>

              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                By integrating a real-time WhatsApp Business API webhook with a centralized sales CRM dashboard, we eliminated manual copy-paste bottlenecks and automated customer inventory catalog inquiries.
              </p>

              <CTAButton
                href="/case-studies/logistics-whatsapp-crm"
                variant="outline"
                size="sm"
            ...
            <div className="w-full lg:w-auto grid grid-cols-2 md:grid-cols-3 lg:flex lg:flex-col gap-4 relative z-10">
              <div className="p-5 rounded-2xl bg-zinc-950/50 border border-white/5 text-center lg:text-left min-w-[180px]">
                <span className="text-2xl md:text-3xl font-extrabold text-white block">85%</span>
                <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mt-1 block">Faster callbacks</span>
              </div>
              
              <div className="p-5 rounded-2xl bg-zinc-950/50 border border-white/5 text-center lg:text-left min-w-[180px]">
                <span className="text-2xl md:text-3xl font-extrabold text-brand-cyan block">32%</span>
                <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mt-1 block">Conversion boost</span>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-zinc-950/50 border border-white/5 text-center lg:text-left col-span-2 md:col-span-1 min-w-[180px]">
                <span className="text-2xl md:text-3xl font-extrabold text-brand-purple block">150+</span>
                <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mt-1 block">Daily orders synced</span>
              </div>
            </div>
          </div>
        </FadeUp>
